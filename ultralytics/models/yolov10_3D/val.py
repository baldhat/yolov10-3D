...
class YOLOv10_3DDetectionValidator(DetectionValidator):
    ...
    def preprocess(self, batch):
        ...
        for k in ["batch_idx", "bboxes", "cls", "depth", "center_3d", "center_2d", "vdepth_factors", "size_2d", "heading_bin",
    ...
    def plot_predictions(self, batch, preds, ni):
        self.visualizer.plot_preds(
            ...
            paths=batch["im_file"],
            fname=self.save_dir / f"val_batch{ni}_pred3d.png",
            names=self.names
        )
        self.visualizer.plot_bev(
            ...
            self.dataloader.dataset,
            paths=batch["im_file"],
            fname=self.save_dir / f"val_batch{ni}_pred_bev.svg",
            names=self.names
        )
