...
class TaskAlignedAssigner3d(nn.Module):
    ...
    def forward(self, pd_scores, pd_bboxes, pd_3d, anc_points, gts, mask_gt, stride_tensor, calibs, mean_sizes):
        ...
        Returns:
            ...
            target_gt_idx (Tensor): shape(bs, num_total_anchors)
        """
        gt_labels, gt_bboxes, gt_center_2d, gt_size_2d, gt_center_3d, gt_size_3d, gt_depth, gt_heading_bin, gt_heading_res, gt_vdepth_factors = gts
        ...
        gt_keypoints = get_3d_keypoints(gt_center_3d, gt_vdepth, gt_size_3d, gt_heading_bin, gt_heading_res, calibs)
    ...
    def get_targets(self, gts, target_gt_idx, fg_mask):
        ...
        gt_vdepth_factors = gt_vdepth_factors.view(-1, gt_vdepth_factors.shape[-1])[target_gt_idx]
        ...
        return [target_labels, target_scores, target_center_2d, target_size_2d, target_center_3d,
                target_size_3d, target_depth, target_heading_bin, target_heading_res, gt_vdepth_factors]
